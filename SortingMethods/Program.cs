...
namespace SortingMethods
{
    internal class Program
    {
        ...
        static void AnalyseComplexity(ISortingAlorithm sortingAlgorithm, int[] arrayForSorting)
        {
            ...
            Console.WriteLine($"Сравнения: {sortingAlgorithm.ComparisonCounter}\tНазначение: {sortingAlgorithm.AssignmentCounter}\n\n");
        }
    }
    ...
    class InclusionSortAlgorithm : ISortingAlorithm
    {
        ...
        public int[] Sort(int[] array)
        {
            ...
            for (int i = 1; i < array.Length; i++)
            {
                ...
                ComparisonCounter++; // сравнение последнего цикла
